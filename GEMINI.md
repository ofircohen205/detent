...
- ⏳ **v1.0 (Production Ready, 6 months):**
  - All 7 agent adapters; security scanning (Bandit, Semgrep, Gitleaks); plugin system; GitHub Actions; OpenTelemetry traces
  - Policy profiles (strict, standard, permissive); Windows support
